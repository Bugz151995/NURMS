    ...
    <div id="layoutSidenav">
      ...
      <main id="layoutSidenav_content">
        ...
        <div id="mainContent">
          ...
          <h6>BUYER</h6> 
          <p>
            A legally enforceable pact. The Purchaser is the highest bidder acknowledge by the Auctioneer and accepted by Numisworks Auction Product Trading, subject to any reserve and the conditions of the General Conditions, if applicable. The Demise of the Auctioneer's Office The moment the Countdown Clock reaches zero (in the case of Live Auctions) or the hammer falls (in the case of Online-Only Auctions), as appropriate (the "Fall of the Hammer"),Because Pilinumis is not a party to the buy and sale transaction, it cannot be held liable or responsible for any violation or default by either Buyer or Seller. Each and every sale is final.
          </p>

          <h6>AUCTIONER</h6>
          <p>
            Pilinumis as Agent for Seller Pilinumis shall not have any liability or responsibility  for any act, omision, defaultof failure by any seller. All items in the Auction are offered by pilinumis as agent for the seller of the item (the"Seller") and not on behalf of pilinumis.
          </p>
